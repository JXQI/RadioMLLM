...
DATA_PATH="/home/tx-deepocean/data1/jxq/data/processed_m3/Slake1.0/slake_test_instruct.json"
IMAGE_DIR="/home/tx-deepocean/data1/jxq/data/processed_m3/Slake1.0/imgs"
OUTPUT_ROOT="$OUTPUT_FOLDER_NAME/slakevqa"
...
python $PROJECT_PATH/m3/eval/scripts/metric_slakevqa.py \
    --input $DATA_PATH \
    --answers $OUTPUT_PATH \
    --output $RESULT_PATH 
