...
DATA_PATH="/home/tx-deepocean/data1/jxq/data/processed_m3/RAD-VQA/radvqa_test_instruct.json"
IMAGE_DIR="/home/tx-deepocean/data1/jxq/data/processed_m3/RAD-VQA/imgs"
OUTPUT_ROOT="$OUTPUT_FOLDER_NAME/radvqa"
OUTPUT_PATH="$OUTPUT_ROOT/answer.json"
...
python $PROJECT_PATH/m3/eval/scripts/metric_radvqa.py \
    --input $DATA_PATH \
    --answers $OUTPUT_PATH \
    --output $RESULT_PATH \
